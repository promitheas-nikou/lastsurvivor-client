...
ToolType StoneBrickWallTile::GetOptimalToolType() const
{
    return TOOL_TYPE;
}

int StoneBrickWallTile::GetMiningResistance() const
{
...
Tile* StoneBrickWallTile::Clone(World* w, int x, int y) const
{
