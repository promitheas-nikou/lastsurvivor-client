...
void SimpleToggleTextButtonUIComponent::Draw(int plane)
{
	...
	al_draw_text(loaded_fonts["default"][30], text_color, 10, GetHeight() / 2 - 15, ALLEGRO_ALIGN_LEFT, text.c_str());

	if(isToggled)
		al_draw_text(loaded_fonts["default"][30], gameconfig::SOLID_TEXT_COLOR_OK, GetWidth() - 10, GetHeight() / 2 - 15, ALLEGRO_ALIGN_RIGHT, "ON");
	else
		al_draw_text(loaded_fonts["default"][30], gameconfig::SOLID_TEXT_COLOR_ERROR, GetWidth() - 10, GetHeight() / 2 - 15, ALLEGRO_ALIGN_RIGHT, "OFF");
}
