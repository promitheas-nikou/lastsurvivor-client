...
void ToolItem::DrawItemDetailsPane(int x, int y) {
	...
	al_draw_textf(loaded_fonts["default"][20], gameconfig::SOLID_TEXT_COLOR_OK, x + 15, y + 45, 0, "Mining Level: %d", this->GetMiningLevel());
	al_draw_textf(loaded_fonts["default"][20], gameconfig::SOLID_TEXT_COLOR_OK, x + 15, y + 67, 0, "Mining Damage: %.1f", this->GetMiningDamage());
